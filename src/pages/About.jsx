...
const About = () => {
  return (
    <div>
      ...
      <div className="flex items-center my-10 flex-col md:flex-row gap-12">
        <img className="w-ful max-w-[360px]" src={assets.about_image} alt="" />
        <div className="flex flex-col text-sm text-gray-600 justify-center gap-6 md:w-2/4 ">
          <p>
