  ...
  return (
    <div className="flex justify-between items-center text-sm py-4 mb-5 border-b border-b-gray-400">
      <img
        ...
        alt=""
      />
      <ul className="hidden md:flex items-start gap-5 font-medium font-poppins">
        <NavLink to={"/"}>
          <li className="py-1">Home</li>
          <hr className="border-none outline-none h-0.5 bg-primary w-2/3 m-auto hidden " />
        </NavLink>
        <NavLink to={"/doctors"}>
      ...
      <div className="flex items-center gap-4">
        {token ? (
          <div className="flex items-center gap-2 transition-all ease-in-out duration-500 cursor-pointer relative group">
        ...
        <div
          ...
          } md:hidden fixed z-20 right-0 top-0 bottom-0 bg-white transition-all `}
        >
          ...
          <ul className="flex flex-col gap-2 px-5  text-lg font-medium text-center ">
            ...
            <NavLink onClick={() => setShoMenu(false)} to={"/doctors"}>
              <p className="uppercase px-4 py-2 rounded inline-block">
                All Doctors
              </p>
            </NavLink>
